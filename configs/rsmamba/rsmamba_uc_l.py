...
#work_dir = '/content/drive/MyDrive/UI/ADSL/RSMambaReg/config/rsmamba/rsmamba_uc_l'

#data_root = '/content/drive/MyDrive/UI/ADSL/RSMambaReg/data/UC'
#code_root = '/content/drive/MyDrive/UI/ADSL/RSMambaReg/datainfo/UC'

work_dir = 'rsmamba_uc_l'
